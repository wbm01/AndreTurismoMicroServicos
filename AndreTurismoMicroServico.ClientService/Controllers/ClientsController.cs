...
namespace AndreTurismoMicroServico.ClientService.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ClientsController : ControllerBase
    {
        private readonly AndreTurismoMicroServicoClientServiceContext _context;

        public ClientsController(AndreTurismoMicroServicoClientServiceContext context)
        {
            _context = context;
        }
